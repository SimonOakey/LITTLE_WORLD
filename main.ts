namespace SpriteKind {
    export const aTREE = SpriteKind.create()
...
function basic_setup () {
    quest_1_text = "Das ist eine Aufgabe, die du loesen musst. Hier ist die laengere Erklaerung dazu. Man kann auch einen Seitenwechsel einbauen, wenn der Text länger sein sollte."
    for (let index = 0; index < 5; index++) {
        aBit = sprites.create(img`
            ......cc66......
            .....c6576c.....
            ....c677576c....
            ....cc677666....
...
myplayer = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
let target_sprite = sprites.create(img`
    f . . . . . . . . . . . . . . f 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
...
mpc = sprites.create(img`
    ...
    . . . . . . . . f f f . . . 
    `, SpriteKind.Player)
mpc.setPosition(111, 89)
target_sprite.setPosition(111, 89)
mpc.follow(target_sprite, 30)
...
game.onUpdate(function () {
    ...
    if (nt != null) {
        target_sprite.x = nt.x
        target_sprite.y = nt.y + 20
    }
})
game.onUpdateInterval(5000, function () {
    ...
    if (treelist.length > 0) {
        nt = treelist[Math.round(Math.random() * treelist.length)]
    }
})
